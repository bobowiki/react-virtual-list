"use strict";(self.webpackChunkreact_virtual_list=self.webpackChunkreact_virtual_list||[]).push([[803],{98531:function(d,n,e){var i;e.r(n),e.d(n,{demos:function(){return I}});var y=e(90228),v=e.n(y),M=e(87999),l=e.n(M),a=e(75271),o=e(69867),P=e(14813),g=e(90674),t=e.n(g),s=e(44395),c=e(82187),m=e.n(c),_=e(99529),I={"react-virtual-list-demo-example":{component:a.memo(a.lazy(function(){return e.e(433).then(e.bind(e,1674))})),asset:{type:"BLOCK",id:"react-virtual-list-demo-example",refAtomIds:["react-virtual-list"],dependencies:{"index.tsx":{type:"FILE",value:e(956).Z},"@ant-design/icons":{type:"NPM",value:"6.1.0"},antd:{type:"NPM",value:"5.29.3"},mockjs:{type:"NPM",value:"1.1.0"},react:{type:"NPM",value:"18.3.1"},"../index.tsx":{type:"FILE",value:e(73328).Z},classnames:{type:"NPM",value:"2.5.1"},"./index.module.css":{type:"FILE",value:e(3249).Z}},entry:"index.tsx"},context:{"../index.tsx":s,"./index.module.css":_,"@ant-design/icons":o,antd:P,mockjs:g,react:i||(i=e.t(a,2)),"/Users/didi/Documents/fronted-end-roadmap/front-book/22-npm-third-lib/src/react-virtual-list/index.tsx":s,classnames:c,"/Users/didi/Documents/fronted-end-roadmap/front-book/22-npm-third-lib/src/react-virtual-list/index.module.css":_},renderOpts:{compile:function(){var u=l()(v()().mark(function f(){var h,D=arguments;return v()().wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.next=2,e.e(228).then(e.bind(e,25228));case 2:return r.abrupt("return",(h=r.sent).default.apply(h,D));case 3:case"end":return r.stop()}},f)}));function x(){return u.apply(this,arguments)}return x}()}}}},44395:function(d,n,e){e.r(n),e.d(n,{ReactVirtualList:function(){return P}});var i=e(48305),y=e.n(i),v=e(82187),M=e.n(v),l=e(75271),a=e(99529),o=e(52676),P=function(t){var s,c,m=t.list,_=t.itemHeight,I=t.itemGap,u=I===void 0?0:I,x=t.overscan,f=x===void 0?5:x,h=t.className,D=t.style,b=t.itemKey,r=t.children,R=(0,l.useRef)(null),O=(0,l.useRef)(null),A=(0,l.useState)(0),L=y()(A,2),S=L[0],C=L[1],p=_+u,U=(s=(c=R.current)===null||c===void 0?void 0:c.clientHeight)!==null&&s!==void 0?s:0,N=Math.ceil(U/p),E=Math.max(Math.floor(S/p)-f,0),B=Math.min(E+N+f*2,m.length),W=E*p,j=(0,l.useMemo)(function(){return m.length*p-u},[m.length,p,u]),H=(0,l.useCallback)(function(){R.current&&(O.current||(O.current=requestAnimationFrame(function(){C(R.current.scrollTop),O.current=null})))},[]);return(0,o.jsxs)("div",{ref:R,className:M()(a.default["react-virtual-list"],h),style:D,onScroll:H,children:[(0,o.jsx)("div",{className:a.default["react-virtual-list-scroll"],style:{height:j}}),(0,o.jsx)("div",{className:a.default["react-real-list-container"],style:{transform:"translateY(".concat(W,"px)")},children:m.slice(E,B).map(function(K,F){var T=E+F;return(0,o.jsx)("div",{className:a.default["react-virtual-list-item"],style:{height:_,marginBottom:u},children:r(K,T)},b?b(K,T):T)})})]})}},99529:function(d,n,e){e.r(n),n.default={"react-virtual-list":"ijYMbwSAvEkDvzI_FrHN","react-virtual-list-scroll":"ia4vQQGvSE32zees6mSc","react-real-list-container":"tqt2Mi86JMjMymYpLuj0","react-virtual-list-item":"QT44jdRTANEk51FqdP98"}},8968:function(d,n,e){e.r(n),e.d(n,{texts:function(){return i}});const i=[{value:"ReactVirtualList",paraId:0,tocIndex:0},{value:" \u662F\u4E00\u4E2A ",paraId:0,tocIndex:0},{value:"\u9AD8\u6027\u80FD\u3001\u8F7B\u91CF\u7EA7\u7684\u865A\u62DF\u6EDA\u52A8\u5217\u8868\u7EC4\u4EF6",paraId:0,tocIndex:0},{value:"\uFF0C",paraId:0,tocIndex:0},{value:`
...
`,paraId:9,tocIndex:6}]},956:function(d,n){n.Z=`import { PhoneFilled } from '@ant-design/icons';
...
`},3249:function(d,n){n.Z=`.react-virtual-list {
    width: 100%;
    height: 100%;
    overflow-y: auto;
    position: relative;
...
}`},73328:function(d,n){n.Z=`import cls from 'classnames';
